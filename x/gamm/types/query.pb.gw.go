...
var (
	...
	pattern_Query_JoinPool_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"osmosis", "gamm", "v1beta1", "pool_id", "join_pool"}, "", runtime.AssumeColonVerbOpt(false)))
